...
public class PackageType {
	...
	public static int data_entity_json = 201;	// 数据库数据，java对象json
	public static int data_entity_image = 202;	// 本地存储的图片文件

	public static int sync_response = 200;		// 同步返回结果，body是json
}
